    ...
    <div class="box-container">
        ...
        <div class="content">
            ...
            <form action="add_to_cart.php" method="post" class="add-to-cart-form">
                ...
                <input type="hidden" name="image" value="../images/chicken.webp">
                <div class="quantity">
        ...
        <div class="content">
            ...
            <form action="add_to_cart.php" method="post" class="add-to-cart-form">
                ...
                <input type="hidden" name="image" value="../images/steak.jpeg">
                <div class="quantity">
                    <button type="button" class="qty-btn minus"><i class="fas fa-minus"></i></button>
                    <input type="number" name="quantity" value="1" min="1" class="qty">
                    <button type="button" class="qty-btn plus"><i class="fas fa-plus"></i></button>
        ...
        <div class="box">
            ...
            <div class="content">           
                ...
                <form action="add_to_cart.php" method="post" class="add-to-cart-form">
                    ...
                    <input type="hidden" name="image" value="../images/salmon.webp">
                    <div class="quantity">
                        <button type="button" class="qty-btn minus"><i class="fas fa-minus"></i></button>
                        <input type="number" name="quantity" value="1" min="1" class="qty">
                        <button type="button" class="qty-btn plus"><i class="fas fa-plus"></i></button>
